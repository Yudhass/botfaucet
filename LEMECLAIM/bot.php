...
$rev="MR.REVOLT";
$yt="";
$SUPP1 = $cyan."Syukron And All My Friend";
$SC = $purple2."1.0";
$SUPP = $cyan."God Almighty and All Who Support Me";
$sawer = "https://saweria.co/MrRevolt";
date_default_timezone_set("Asia/Jakarta");
system("clear");
echo "\033[01;38;5;226m";
system("toilet -f wideterm -F border ' L E M E - C L A I M  . CLUB( ONLINE ) '");
...
\033[1;93m===================================================================
\033[1;96m•SCRIPT INI GRATIS DAN TIDAK UNTUK DI JUAL JADI JANGAN BANYAK MENGELUH

\033[1;37m •THANKS TO       :\033[1;97m $SUPP
\033[1;37m •SUPPORT         :\033[1;91m $SUPP1
...
echo $lblue2."$nual".$putih2."$lblue  $nual1";  echo $green2."     $nual17".$putih2."$green2  $nual18";
echo"\n";
echo $yellow2."$nual3".$putih2."$yellow2 $nual4";  echo $lblue2."     $nual20".$putih2."$purple2 $nual21";
echo"\n";
echo $lblue2."$nual6".$putih2."$lblue2  $nual7";  echo $purple2."     $nual23".$putih2."$yellow2  $nual24";
echo"\n";
echo $r1."$nual9".$putih2."$r1  $nual10"; echo $yellow2."     $nual26".$putih2."$red2  $nual27";
echo"\n";
echo $y1."$nual12".$putih2."$green2 $nual13"; echo $purple2."     $nual29".$putih2."$yellow2  $nual30";
echo"\n";
an($lblue2."~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~".$and."\n");
// BAGIAN WELCOME
